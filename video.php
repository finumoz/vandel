...
body { background-color: #111111; }
 ...
 <div class="ter">
 <video width="500" height="400" controls="controls" poster="video/duel.jpg">
   <source src="video/duel.ogv" type='video/ogg; codecs="theora, vorbis"'>
   <source src="video/detstvo.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
   <source src="video/duel.webm" type='video/webm; codecs="vp8, vorbis"'>
   Тег video не поддерживается вашим браузером. 
   <a href="video/detstvo.mp4">Скачайте видео</a>
 </div>
 </center>
